  ...
  <div class="o-row u-vh-100 u-items-center">
    <div class="o-column o-column-6@sm o-column-5@md">
      <section class="c-login">
        <h1 class="u-fs-24 u-mb-32">Área Restritra - Kabum</h1>
        <form action="<?= ENDPOINT_AUTH ?>" method="POST">
          <div class="c-textfield js-float-field">
            <div class="c-textfield u-mb-24">
              <input type="text" value="" id="username" name="username" class="c-textfield__input js-float-input"
                required>
          ...
          <div class="c-textfield js-float-field">
            <div class="c-textfield u-mb-24">
              <input type="password" value="<?= $cpf ?>" id="password" name="password"
          ...
          <div class="">
            <button type="submit" class="c-button c-button--primary u-w-100 js-submit"><span
                class="lni lni-enter u-fs-18"></span>
              ENTRAR
            </button>
          </div>
        </form>
