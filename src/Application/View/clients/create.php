...
<div class="o-container">
  <div class="u-mb-24 u-db u-flex@sm u-items-center">
    <a href="<?= BASEURL_CLIENT_LIST ?>" class="c-button c-button--tertiary u-td-none u-fs-12 u-fs-12 u-fw-600">
      <span class="lni lni-chevron-left"></span>
      <span>Voltar</span>
    </a>
  </div>
  <div class="u-justify-between u-db u-fs-14 u-dn u-mb-24 u-mb-0@sm u-flex-column">
    <h2 class="u-fs-24 u-mb-0@sm u-fw-800">
      <?= $isUpdate ? 'Atualizar cliente' : 'Novo cliente' ?>
    </h2>
    <br />
  </div>

  <form action="<?= $isUpdate ? sprintf(ENDPOINT_CLIENT_UPDATE, $client['client_id']) : ENDPOINT_CLIENT_CREATE ?>"
    ...
    <div class="o-row">
      <div class="o-column o-column-6@sm o-column-6@md">
        <div class="c-textfield js-float-field">
          <div class="c-textfield u-mb-24">
            <input type="text" maxlength="80" value="<?= $name ?>" id="name" name="name"
              class="c-textfield__input js-float-input" required>
      ...
      <div class="o-column o-column-6@sm o-column-6@md">
        <div class="c-textfield js-float-field">
          <div class="c-textfield u-mb-24">
            <input type="text" value="<?= $birthdate ?>" id="birthdate" name="birthdate"
              class="c-textfield__input js-float-input" data-mask-birthdate required>
    ...
    <div class="o-row">
      <div class="o-column o-column-6@sm o-column-6@md">
        <div class="c-textfield js-float-field">
          <div class="c-textfield u-mb-24">
            <input type="text" value="<?= $phone ?>" id="phone" name="phone" class="c-textfield__input js-float-input"
      ...
      <div class="o-column o-column-6@sm o-column-6@md">
        <div class="c-textfield js-float-field">
          <div class="c-textfield u-mb-24">
            <input type="text" maxlength="12" value="<?= $rg ?>" id="rg" name="rg"
              class="c-textfield__input js-float-input" required>
    ...
    <div class="o-row">
      <div class="o-column o-column-6@sm o-column-6@md">
        <div class="c-textfield js-float-field">
          <div class="c-textfield u-mb-24">
            <input type="text" value="<?= $cpf ?>" id="cpf" name="cpf" class="c-textfield__input js-float-input"
