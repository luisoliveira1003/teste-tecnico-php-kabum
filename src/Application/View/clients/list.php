...
<div class="o-container">
  ...
  <div class="u-justify-between u-db u-flex@sm u-mb-32">
    ...
    <div class="u-flex u-items-center">
      <a href="<?= BASEURL_CLIENT_CREATE ?>" class="c-button c-button--primary u-w-100"><span
          class="lni lni-plus u-mr-4 u-fs-12 u-fw-600"></span> Adicionar cliente</a>
    </div>
  </div>
  <?php
  if (!$data['hasRecords']) { ?>
    ...
    <ul class="o-list c-list">
      <li class="c-list__header">
        <div class="o-row">
          ...
          <div class="o-column o-column-3@sm u-fs-14 u-fw-600">
            Telefone
          </div>
          <div class="o-column o-column-2@sm u-fs-14 u-fw-600">
            CPF
          </div>
      ...
      foreach ($data['list'] as $item) {
        ...
        <li class="c-list__item">
          <div class="o-row">
            ...
            <div class="o-column o-column-3@sm u-flex u-items-center u-fs-14">
              <?
              $phone = $item['phone'];
              $maskedCpf = sprintf("(%s) %s-%s", substr($phone, 0, 2), substr($phone, 2, 5), substr($phone, 7, 9));
              echo $maskedCpf;
              ?>
            </div>
            <div class="o-column o-column-2@sm u-flex u-items-center u-fs-14">
              <?
              $cpf = $item['cpf'];
            ...
            <div class="o-column o-column-2@sm c-list__actions u-tr@sm u-mt-8 u-mt-0@sm">
              ...
              <a href="javascript:;" class="js-list-remove u-pd-8" data-id="<?= $item['client_id'] ?>"><span
                  class="lni lni-trash"></span></a>
            </div>
          </div>
        </li>
      <?php } ?>
  ...
  <?php if ($data['hasRecords']) { ?>
    <div class="u-mb-24 u-mb-0@sm u-mt-4 u-justify-between u-db u-mt-4 u-flex@sm u-fs-14 u-dn u-flex@sm u-fw-200">
      ...
      Mostrando
      <?= $data['count'] ?>
      <?= $data['count'] < 2 ? 'registro' : 'registros' ?>
    </div>
  <?php } ?>
</div>
