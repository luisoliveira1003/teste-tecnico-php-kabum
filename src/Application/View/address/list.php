...
<div class="o-container">
  ...
  <div class="u-justify-between u-db u-flex@sm u-mb-32">
    <div class="u-justify-between u-db u-fs-14 u-dn u-mb-24 u-mb-0@sm u-flex-column">
      ...
      <span class="c-badge c-badge--orange u-mt-4">Cliente:
        <?= $data['client']['name'] ?>
      </span>
    </div>
    <div>
      <a href="<?= sprintf(BASEURL_CLIENT_ADDRESS_CREATE, $data['client_id']) ?>"
        class="u-flex u-items-center u-justify-center c-button c-button--primary u-td-none"><span
          class="lni lni-plus u-mr-4"></span> Adicionar endereço</a>
    </div>
  </div>
        ...
        <li class="c-list__item">
          <div class="o-row">
            ...
            <div class="o-column o-column-2@sm c-list__actions u-tr@sm u-mt-8 u-mt-0@sm">
              ...
              <a href="javascript:;" class="js-list-remove u-pd-8" data-id="<?= $item['address_id'] ?>"><span
